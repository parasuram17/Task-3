import { EmployeeData, EmployeeFormData, RoleData, TypeCheck } from "../Types/Types.js";

class DOMInsert {
    insertData(dataObject: EmployeeData | RoleData | EmployeeFormData) {
        if (TypeCheck.instanceofEmployeeData(dataObject)) {
            ...
            let empContainer: HTMLElement = document.querySelector('.emp-details') as HTMLElement;
            ...
            let cardBody: HTMLElement = document.querySelector('.cards') as HTMLElement;
            ...
            let ID: HTMLElement = document.getElementById(cardID) as HTMLElement;
            let cardImgs: HTMLElement = ID.querySelector('.card-imgs') as HTMLElement;
            ...
            let empCardBody: HTMLElement = document.querySelector('.cards') as HTMLElement;
    ...
    getImgFromID(imgID: string) {
        let employeeData: string = localStorage.getItem("employeeData") as string;
